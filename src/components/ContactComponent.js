                        ...
                        <Form onSubmit={this.HandleSubmit}>
                            ...
                            <FormGroup row>
                                <Col md={{size:6,offset:2}}>
                                    <FormGroup check>
                                        <Label check>
                                            <Input type="checkbox" id="agree" name="agree" value={this.state.agree} onChange={this.HandleInputChange}/>{' '}
                            ...
                            <Col md={10}>
                                <Input type="textarea" rows="10" id="message" name="message" value={this.state.message} onChange={this.HandleInputChange}/>
                            </Col>
                            </FormGroup>
                            <FormGroup row>
